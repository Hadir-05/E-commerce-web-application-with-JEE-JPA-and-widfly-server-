...
<c:import url="home.jsp">
	<c:param name="page" value="updateproduct"></c:param>
</c:import>

<div class="container col-md-6">
	<h2 style="text-align:center">Modifier un produit</h2>
		<c:if test='${model.msg=="updateproduct" }'>
			<div style="text-align:center" class='alert-info'>Produit modifié avec succées	</div>
		</c:if>
		<hr>
	<div class="panel panel-primary">
		...
		<div class="form-group">
			...
			<input type="number" name="id" class="form-control" placeholder="id du produit"><br>
		</div>
		<br><br>
		<div class="form-group">
